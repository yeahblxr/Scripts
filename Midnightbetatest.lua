...
local Paragraph = Tab:CreateParagraph({Title = "Midnight Hub Changelogs *8/3/25", Content = "Changed the fly gui to my own fly gui, Changed the noclip gui to a toggle"})
