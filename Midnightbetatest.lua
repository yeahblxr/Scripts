...
local Paragraph = Tab:CreateParagraph({Title = "Midnight Hub Changelogs *7/22/25", Content = "Added set fps cap, Moved Fps boost to different section,  Server > client "})
